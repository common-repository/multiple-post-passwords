    ...
    public function display_field($args)
    {
        ...
        switch ($field['type']) {
            ...
            case 'number':
                ...
                if(isset($field['min']) && strlen($field['min']) > 0){
                ...
                $html .= '<input id="' . esc_attr($field['id']) . '" type="' . $field['type'] .
                    '" name="' . esc_attr($option_name) . '" ' . $placeholder .
                    ' value="' . esc_textarea($data) . '" '.$params.'/>' . PHP_EOL;
                break;
            ...
            case 'checkbox':
                ...
                $html .= '<input id="' . esc_attr($field['id']) . '" type="' . $field['type'] .
                    '" name="' . esc_attr($option_name) . '" ' . $checked . '/>' . PHP_EOL;
                break;
